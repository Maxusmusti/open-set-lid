...
#     os.rename(path + filename + '.wav', path + 'spa_puertoricancs_' + sex + '_u-' + f'{i:05}' + '.wav') # rename wav
#     os.rename(path + filename + '.txt', path + 'spa_puertoricancs_' + sex + '_u-' + f'{i:05}' + '.txt') # rename txt
#     i+=1
