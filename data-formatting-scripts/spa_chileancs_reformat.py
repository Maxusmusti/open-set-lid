...
# os.remove('../spanishchilean/_transcript.txt')



"""
Trim to 12000 seconds
"""
# path='../spanishchilean/'
# os.chdir(path)
# time = 0
...
#     os.rename(path + filename + '.wav', path + 'spa_chileancs_' + sex + '_u-' + f'{i:05}' + '.wav') # rename wav
#     os.rename(path + filename + '.txt', path + 'spa_chileancs_' + sex + '_u-' + f'{i:05}' + '.txt') # rename txt
#     i+=1
